...
bot = telebot.TeleBot('1670591810:AAEXyawvlEZ02ZuARClHD6u8ECaD7NNSZ-0') # Токен бота воркеров

admin = 701223439 # ID Админа
support = 701223439 # ID сапорта
channel_id = -1001290744045 # ID Канала залётов
chat_worker_id = 1492517820 # ID Чата с воркерами

bot_name = 'fonbeet_bot' # Username Бота

mater = 't.me/joinchat/TO8w7fmTMpQ0x3xC' # Ссылка на мануалы
zalet = 't.me/joinchat/TO8w7fmTMpQ0x3xC' # Ссылка на канал с залётами
infos = 't.me/joinchat/TO8w7fmTMpQ0x3xC' # Ссылка на инфо канал
pname = 'Fonbet team' # Название проекта
pdate = '29.01.2021' # Дата созданя проекта
